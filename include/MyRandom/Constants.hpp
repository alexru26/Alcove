...
inline extern const std::vector<std::string> CITIES = {
    ...
    "Bangkok", "Mumbai", "Barcelona", "Vienna", "Jakarta", "Melbourne", "Dublin", "Copenhagen", "Stockholm", "Zurich",
    "Amsterdam", "Lisbon", "Brussels", "Buenos Aires", "Mexico City", "São Paulo", "Lima", "Bogotá", "Warsaw", "Prague",
